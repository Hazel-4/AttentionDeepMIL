...
def generate_txt(save_mode, train_img_dir):
    ...
    if save_mode == "train":
        save_txt_path = os.path.join(save_txt_dir, "image.txt")
    else:
...
if __name__ == "__main__":
    # 将训练集图片保存为txt文件
    generate_txt("train", "./data/image/")
    # 将测试集图片保存为txt文件
    # generate_txt("train", "/media/Store/tyh/funi_across_validation/data/2016/test")
